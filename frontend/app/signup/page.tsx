...
export default function SignupPage() {
  ...
  const [errors, setErrors] = useState({ name: "", email: "", location: "" })
  ...
  const handleNext = () => {
    const newErrors = { name: "", email: "", location: "" }
    let hasError = false
          ...
          {step === 1 && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <motion.div
                  className="space-y-1"
                  animate={isShaking && errors.name ? "shake" : ""}
                  variants={{
                ...
                >
                  ...
                  <div className="h-4">
                    {errors.name && (
                      <p className="text-xs text-destructive leading-none">
                        {errors.name}
                      </p>
                    )}
                  </div>
          ...
          {step === 2 && (
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Choose how you'll participate in CropTrust
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Farmer option */}
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    List your crops and reach buyers directly
                  </p>
                </motion.button>
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Discover fresh crops from verified farmers
                  </p>
                </motion.button>
                ...
                <motion.div
                  className="space-y-1"
                  animate={isShaking && errors.location ? "shake" : ""}
                  variants={{
                    shake: { x: [0, -10, 10, -10, 10, 0] },
                  }}
                  transition={{ duration: 0.5 }}
